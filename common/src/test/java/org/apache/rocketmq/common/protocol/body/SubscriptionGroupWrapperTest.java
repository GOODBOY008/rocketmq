...
public class SubscriptionGroupWrapperTest {
    ...
    void testFromJson(){
        ...
        Assertions.assertEquals(fromJson.getSubscriptionGroupTable()).containsKey("Consumer-group-one");
        Assertions.assertEquals(fromJson.getSubscriptionGroupTable().get("Consumer-group-one").getGroupName(),"Consumer-group-one");
        Assertions.assertEquals(fromJson.getSubscriptionGroupTable().get("Consumer-group-one").getBrokerId(),1234);
    }
